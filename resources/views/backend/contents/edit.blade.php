                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-8 mx-auto">
                                    <form action="{{ route('courses.update-content', [$content->id]) }}" method="POST"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="name" id="name"
                                                    placeholder="Judul Materi..." value="{{ $content->name }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="video_id" id="video_id"
                                                    ...
                                                    value="https://youtu.be/{{ $content->video_id }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea class="summernote-simple" name="instructor_note"
                                                    id="instructor_note">{!!  $content->instructor_note !!}</textarea>
                                            </div>
                                        </div>
