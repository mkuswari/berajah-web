    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item align-self-center {{ Request::is('/') ? 'active' : '' }}">
                    <a class="nav-link" href="{{ url("/") }}">Home <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item align-self-center {{ Request::is('kelas') ? 'active' : '' }}">
                    <a class="nav-link" href="{{ route('kelas') }}">Kelas</a>
                </li>
                <li class="nav-item align-self-center {{ Request::is('kategori') ? 'active' : '' }}">
